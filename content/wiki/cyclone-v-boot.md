...
{{< figure src="/ox-hugo/manual-boot-flow.png" caption="<span class=\"figure-number\">Figure 1: </span>Technical Reference Manual Diagram of Typical Boot Flow" >}}
...
{{< figure src="/ox-hugo/preloader-image-layout.png" caption="<span class=\"figure-number\">Figure 2: </span>PreLoader Image Layout" >}}
...
{{< figure src="/ox-hugo/preloader-remapping-memory.png" caption="<span class=\"figure-number\">Figure 3: </span>Memory state of the Cyclone V HPS before and after executing a (compliant) PreLoader" >}}
